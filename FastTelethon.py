...
async def _internal_transfer_to_telegram(client: TelegramClient,
    ...
    if is_large:
        return InputFileBig(file_id, part_count, nomefile), file_size
    else:
        return InputFile(file_id, part_count, nomefile, hash_md5.hexdigest()), file_size
...
async def upload_file(client: TelegramClient,
    ...
    res = (await _internal_transfer_to_telegram(client, file, progress_callback, nomefile))[0]
    return res